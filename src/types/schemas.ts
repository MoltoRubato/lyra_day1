...
export const WorkspaceDescriptionInput = z.object({
  id: z.string(),
  description: z.string().nullable(),
});
export const WorkspaceToggleStarInput = z.object({
  id: z.string(),
  starred: z.boolean(),
});
...
export const BaseToggleStarInput = z.object({
  id: z.string(),
  starred: z.boolean(),
});
export const BaseMoveInput = z.object({
  id: z.string(),
  workspaceId: z.string().nullable(),
});
...
export const ViewOutput = z.object({
  ...
  order: z.number(),
  groupByColumnId: z.string().nullable(),
  tableId: z.string(),
  createdAt: z.date(),
  updatedAt: z.date(),
});
export const ViewCreateInput = z.object({
  tableId: z.string(),
  name: z.string().min(1),
  type: z.nativeEnum(ViewType).default("GRID"),
});
export const ViewRenameInput = z.object({
  viewId: z.string(),
  name: z.string().min(1),
});
export const ViewDeleteInput = z.object({ viewId: z.string() });
export const ViewUpdateConfigInput = z.object({
  viewId: z.string(),
  groupByColumnId: z.string().nullable(),
});
...
export const ColumnDescriptionInput = z.object({
  columnId: z.string(),
  description: z.string().nullable(),
});
export const ColumnDuplicateInput = z.object({
  columnId: z.string(),
  duplicateCells: z.boolean().default(true),
});
