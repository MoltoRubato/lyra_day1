...
export const SelectOptionOutput = z.object({
  id: z.string(), label: z.string(), color: z.string(),
  order: z.number(), columnId: z.string(),
});
export const SelectOptionAddInput    = z.object({ columnId: z.string(), label: z.string(), color: z.string().default("#5b6af7") });
