...
export function FieldTypePicker({
  ...
  return (
    <div className="absolute top-full left-0 z-50 mt-1 max-h-72 w-52 overflow-y-auto rounded-xl border border-[#e2e5e9] bg-white p-1 shadow-xl">
      {FIELD_TYPE_GROUPS.map((group) => (
        <div key={group.label}>
          <p className="px-2 pt-2 pb-1 text-[9px] tracking-widest text-[#9ca3af] uppercase">
            {group.label}
          </p>
          {group.types.map((t) => {
...
export function OptionsPanel({
  ...
  return (
    <div
      className="absolute top-full left-0 z-50 mt-1 w-64 rounded-xl border border-[#e2e5e9] bg-white p-3 shadow-xl"
      onClick={(e) => e.stopPropagation()}
    >
      <p className="mb-2 text-[9px] tracking-widest text-[#9ca3af] uppercase">
        Options
      </p>
      ...
      <div className="mb-3 max-h-48 space-y-1 overflow-y-auto">
        ...
        {options.length === 0 && (
          <p className="text-[13px] text-[#9ca3af] italic">No options yet</p>
        )}
      </div>
      ...
      <div className="flex items-center gap-1 border-t border-[#e2e5e9] pt-2">
        ...
        <input
          className="flex-1 rounded-lg border border-[#e2e5e9] bg-white px-2 py-0.5 text-[13px] text-[#1f2937] placeholder-[#9ca3af] outline-none focus:border-[#166254]"
