...
export const PencilIco = ({ size = 11 }: { size?: number }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 12 12"
...
export const MoveIco = ({ size = 11 }: { size?: number }) => (
  <AssetIco asset={152} size={size + 4} />
);
export const TrashIco = ({ size = 11 }: { size?: number }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 12 12"
...
export const RenameMenuIco = ({ size = 14 }: { size?: number }) => (
  <AssetIco asset={141} size={size} />
);
export const DuplicateMenuIco = ({ size = 14 }: { size?: number }) => (
  <AssetIco asset={320} size={size} />
);
export const MoveMenuIco = ({ size = 14 }: { size?: number }) => (
  <AssetIco asset={434} size={size} />
);
export const GoToWorkspaceMenuIco = ({ size = 14 }: { size?: number }) => (
  <AssetIco asset={14} size={size} />
);
export const CustomizeMenuIco = ({ size = 14 }: { size?: number }) => (
  <AssetIco asset={150} size={size} />
);
export const DeleteMenuIco = ({ size = 14 }: { size?: number }) => (
  <AssetIco asset={32} size={size} />
);
