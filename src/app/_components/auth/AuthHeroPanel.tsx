...
function TileOne() {
  return (
    <div className="relative h-[110px] rounded-[12px] bg-gradient-to-br from-[#3d3f44] to-[#212431]">
...
function TileTwo() {
  return (
    <div className="relative h-[110px] rounded-[12px] bg-[#de94e2]">
...
function TileThree() {
  return (
    <div className="relative h-[110px] overflow-hidden rounded-[12px] bg-[#bb4f34]">
...
function TileFour() {
  return (
    <div className="relative h-[110px] overflow-hidden rounded-[12px] bg-[#f8c7ad]">
...
function TileFive() {
  return (
    <div className="relative h-[110px] rounded-[12px] bg-[#dff2d8] p-3">
...
function TileSix() {
  return (
    <div className="relative h-[110px] overflow-hidden rounded-[12px] bg-[#2f3442]">
...
export function AuthHeroPanel() {
  return (
    <aside className="hidden h-[580px] w-[395px] rounded-[24px] bg-[#4a0055] px-5 pb-5 pt-12 text-white lg:flex lg:flex-col">
      <h2 className="max-w-[340px] text-[32px] font-semibold leading-[1.18]">
        Meet Omni, your AI collaborator for building custom apps.
      </h2>

      <button
        type="button"
        className="mt-7 inline-flex h-[35px] w-fit items-center rounded-[10px] bg-white px-5 text-[13px] font-semibold text-[#1f2937]"
      >
        Start building
      </button>
